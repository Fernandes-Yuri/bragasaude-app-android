...
public interface UpsertExamItemMutation :
    ...
    >
{
    ...
    val measuredAt: com.google.firebase.dataconnect.OptionalVariable<@kotlinx.serialization.Serializable(with = com.google.firebase.dataconnect.serializers.TimestampSerializer::class) com.google.firebase.Timestamp?>,
      ...
      public companion object {
        ...
        public fun build(
          ...
          .let {
            Variables(
              id=id,examId=examId,userId=userId,itemKey=itemKey,itemName=itemName,valueNumeric=valueNumeric,valueText=valueText,unit=unit,referenceText=referenceText,status=status,measuredAt=measuredAt,
            )
          }
        }
      }
  ...
  public data class Data(
    ...
    val examItem_upsert: ExamItemKey,
  ...
  public companion object {
    public val operationName: String = "UpsertExamItem"
...
public fun UpsertExamItemMutation.ref(
  
    examId: java.util.UUID,userId: String,itemKey: String,itemName: String,

  
    block_: UpsertExamItemMutation.Variables.Builder.() -> Unit = {}
  ...
  ref(
      ...
      UpsertExamItemMutation.Variables.build(
...
public suspend fun UpsertExamItemMutation.execute(
