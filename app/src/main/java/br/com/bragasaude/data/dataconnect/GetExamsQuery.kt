...
public interface GetExamsQuery :
    ...
    >
{
  ...
  public companion object {
    public val operationName: String = "GetExams"
...
public suspend fun GetExamsQuery.execute(
  ...
  public fun GetExamsQuery.flow(
    
      userId: String,

  
    
    ): kotlinx.coroutines.flow.Flow<GetExamsQuery.Data> =
    ref(
